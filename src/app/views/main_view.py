...
class MainView:
    def __init__(self, page: ft.Page, settings_service=None):
        ...
        self.settings_view = SettingsView(page, on_settings_changed=on_settings_changed)
    ...
    def build(self):
        ...
        self.tabs = ft.Tabs(
            ...
            tabs=[
                ...
                ft.Tab(
                    text="Налаштування",
                    icon=ft.Icon(ft.Icons.SETTINGS, badge=ft.Badge(small_size=8) if self.settings_view.has_unsaved_changes else None),
